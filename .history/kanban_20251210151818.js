...
if (!raw || raw === "undefined") {
    raw = "{}";   // because you're saving object {todo:[], progress:[], done:[]}
}

let taskData = JSON.parse(raw);
...
if(localStorage.getItem("tasks")){
    ...
    console.log("the Data is :", data);
        ...
        console.log("the Col", colKey );
        console.log("the Col is:", data[colKey][0]?.desc );
        console.log("the Col is:", data[colKey][0]?.title );

         const task = document.createElement("div");
    task.classList.add("task");
   
    task.style.margin = "8px";
    task.setAttribute("draggable", "true");

    // Title
    const h3 = document.createElement("h3");
    h3.textContent = data[colKey][0]?.title;

    // Description
    const p = document.createElement("p");
    p.textContent = data[colKey][0]?.desc 
    ...
    console.log("button delete-", deleteBtn);
...
addTaskbtn.addEventListener('click', () => {
    ...
    columns.forEach(col => 
        ...
        console.log("taskData", taskData);
          ...
          // first time task is defined here......................
